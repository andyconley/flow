# Assignment Brief: Architecture

- Role: architect
- Provider: `/root/release_gate_architecture`
- Task: shape the workflow, permission boundary, exact-SHA/version invariants, structured artifacts, concurrency, and failure behavior.
