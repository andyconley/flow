# Assignment Brief: Handback

- Role: tech writer
- Provider: `/root/release_gate_handback`
- Task: turn final implementation, review, validation, and publication evidence into a concise durable handback that distinguishes completed proof, surrogate evidence, manual limitations, remaining risks, and exact resume actions.
