...
- [ ] A job started or shaped in ChatGPT Work can be inspected/refined in Claude Code and planned/delivered in Codex using the same run ID, charter version/digest, artifacts, and lifecycle state.
...
- [ ] Tests demonstrate zero provider sends for invalid charter, unapproved transition, roster expansion, provider substitution, duplicate grant, and out-of-charter amendment attempts.
