...
| AC7 | Worker: `test_denial_is_reported_to_the_manager_and_a_new_proposal_escalates_again`, `test_denial_then_completion_within_the_charter`. Manager (E5a): `test_denied_manager_call_seals_the_attempt_failed` (hermetic and MAF). |
