...
Approved by Andy on 2026-09-11 as part of plan acceptance. This specifies implementation proof to execute, not completed test evidence. Use the isolated checkout and pilot source/config identities in plan.md. The root coordinator reconciles role findings; an independent reviewer examines source provenance, policy oracles and mutation proof before pilot acceptance.
