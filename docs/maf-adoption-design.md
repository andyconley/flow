...
Status: architecture direction accepted 2026-09-19. The supervised local runner and a bounded local-plus-Codex fixture job now run through Flow's gateway. This proves the mixed-provider boundary in an isolated exercise; broader production integration remains future work. The four completed spikes are research evidence, not the acceptance job.
